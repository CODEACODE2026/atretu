...
export const adminTheme = {
  ...
  card:
    "min-w-0 rounded-xl border border-slate-200/80 bg-white/95 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_12px_28px_rgba(15,46,46,0.035)]",
  cardHover:
  ...
  page:
    "mx-auto grid min-w-0 w-full max-w-[1520px] gap-6 px-4 py-5 sm:px-6 lg:px-8",
  primaryButton:
