import { BarChart3, Layers3, ReceiptText, WalletCards } from "lucide-react";
...
export function FinanceNavigation({
  ...
  return (
    <nav aria-label="Áreas do Financeiro" className="grid min-w-0 gap-2 sm:grid-cols-2 xl:grid-cols-4">
      {items
