...
assert.match(panel, /Em breve/);
assert.match(panel, /Esta permissão ainda não está disponível para perfis de usuário/);
assert.match(panel, /comingSoonPermissionCatalog/);
